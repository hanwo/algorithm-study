...
public class kakao_recruit_신규아이디추천 {
    public static String solution(String new_id) {
        ...
        // step 6
        answer = answer.substring(0, Math.min(answer.length(), 15)).replaceAll("[.]$", "");
...
//        String name = solution("...!@BaT#*..y.abcdefghijklm");
        String name = solution("z-+.^.");
